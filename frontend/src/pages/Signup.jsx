          ...
          <div style={{
            ...
            {apiError && (
              <motion.div
                ...
                style={{ marginBottom: 18, fontSize: '0.85rem' }}
              >
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <Field label="Full name" error={errors.name}>
                <input
                  ...
                  placeholder="Jane Smith" disabled={loading} autoComplete="name"
                />
              </Field>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <Field label="Password" error={errors.password}>
                  <input
                    ...
                    onChange={handleChange} className="input-modern"
                    placeholder="Min 8 chars" disabled={loading} autoComplete="new-password"
                  />
                </Field>
                <Field label="Confirm password" error={errors.password_confirm}>
                  <input
                    ...
                    onChange={handleChange} className="input-modern"
                    placeholder="Repeat" disabled={loading} autoComplete="new-password"
                  />
                </Field>
              </div>
